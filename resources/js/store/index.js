    ...
    actions: {
        loadMovies(context, payload) {
            return new Promise((resolve, reject) => {
                axios.get('/api/v1/movies?page=' + payload.page)
                .then(response => {
                    resolve(response)
                })
                .catch(errors => {
        ...
        movieDetails(context, payload) {
            return new Promise((resolve, reject) => {
                axios.get('/api/v1/movies/' + payload.id)
                .then(response => {
                    resolve(response)
                })
                .catch(errors => {
        ...
        postComment(context, payload) {
            ...
            return new Promise((resolve, reject) => {
                axios.put('/api/v1/movie/' + payload.movieId + '/comment/new', {
        ...
        newMovie(context, payload) {
            ...
            return new Promise((resolve, reject) => {
                axios.post('/api/v1/movie/new', payload)
                .then(response => {
                    resolve(response)
                })
                .catch(errors => {
